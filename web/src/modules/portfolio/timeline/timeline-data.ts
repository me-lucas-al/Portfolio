...
export const timelineMilestones: TimelineMilestone[] = [
  ...
  },
  {
    ...
    impactPt: "Um conselho de uma professora de UX virou o motivo de você estar lendo isto agora: a decisão de contar a história do portfólio, não só mostrar o resultado.",
    impactEn: "Advice from a UX professor became the reason you're reading this right now: the decision to tell the portfolio's story, not just show the result.",
    ...
    inflectionPt:
      "Numa conversa com uma professora de UX, veio o conselho que mudou o rumo do projeto: contar a história do portfólio de forma criativa, ir além da vitrine e mostrar os problemas enfrentados, os pivôs de rota e como as ideias surgiram e foram resolvidas. Decidi então minerar o próprio histórico de commits pra reconstruir essa narrativa de verdade, em vez de escrever algo genérico — cada fase que você vê nesta timeline veio de commits reais, com data e tudo.",
    inflectionEn:
      "In a conversation with a UX professor, came the advice that changed the project's direction: tell the portfolio's story in a creative way, go beyond the showcase and show the problems faced, the route pivots, and how ideas came up and got resolved. I then decided to mine the actual commit history to reconstruct that narrative for real, instead of writing something generic — every phase you see in this timeline came from real commits, dates included.",
    solutionPt:
