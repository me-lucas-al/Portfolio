  ...
  return (
    <form action={formAction} className="space-y-5 p-4">
      ...
      <div className="space-y-2">
        ...
        <input name="imagesUrl" defaultValue={project.imagesUrl?.join(", ") ?? ""} placeholder="https://..." disabled={user} className="w-full px-4 py-3 rounded-xl bg-neutral-900/50 border border-neutral-800 text-white focus:outline-none focus:border-blue-800 transition-all disabled:opacity-50" />
      </div>
